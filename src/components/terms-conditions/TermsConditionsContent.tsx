  ...
  return (
    <Container maxWidth="lg" sx={{ mt: 4, mb: 4 }}>
      ...
      <Typography variant="body1" paragraph>
        Welcome to Nila Foods.
      </Typography>
      <Typography variant="body1" paragraph>
        These Terms of Service (“Terms”, “Terms of Service”) govern your use of
        our website located at Nagercoilfoods.com (together or individually
        “Service”) operated by Nila Foods.
      </Typography>
      ...
      <Typography variant="body1" paragraph>
        ...
        support@nagercoilfoods.com so we can try to find a solution. These Terms
      ...
      <Typography variant="body1" paragraph>
        Nila foods. has the right but not the obligation to monitor and edit all
        Content provided by users.
      </Typography>
      <Typography variant="body1" paragraph>
        In addition, Content found on or through this Service are the property
        of Nila foods. or used with permission. You may not distribute, modify,
      ...
      <Typography variant="body1" paragraph>
        ...
        Service. Use any robot, spider, or other automatic device, process, or
        means to access Service for any purpose, including monitoring or copying
        any of the material on Service. Use any manual process to monitor or
        copy any of the material on Service or for any other unauthorized
        purpose without our prior written consent. Use any device, software, or
        routine that interferes with the proper working of Service. Introduce
        any viruses, trojan horses, worms, logic bombs, or other material which
        is malicious or technologically harmful. Attempt to gain unauthorized
        ...
        connected to Service. Attack Service via a denial-of-service attack or a
        distributed denial-of-service attack. Take any action that may damage or
        falsify Company rating. Otherwise attempt to interfere with the proper
        working of Service.
      </Typography>
      <Typography variant="h4" component="h1" gutterBottom align="left">
        6. Analytics
      ...
      <Typography variant="body1" paragraph>
        ...
        Nila Foods and its licensors. Service is protected by copyright,
      ...
      <Typography variant="body1" paragraph>
        ...
        via email to support@nagercoilfoods.com, with the subject line:
      ...
      <Typography variant="body1" paragraph>
        You may provide us either directly at support@nagercoilfoods.com or via
      ...
      <Typography variant="body1" paragraph>
        ...
        are not owned or controlled by Nila Foods.
      </Typography>
      <Typography variant="body1" paragraph>
        Nila Foods has no control over, and assumes no responsibility for the
